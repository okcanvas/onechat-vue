	...
	<el-container>
		<el-aside width="200px" class="l-friend-box">
			<div class="l-friend-header">
				...
				<el-button plain icon="el-icon-plus" style="border: none; padding:12px; font-size: 20px;color: black;" title="친구추가"
				...
				<div class="user-detail">
					...
					<div class="info-item">
						<el-descriptions title="好友信息" class="description" :column="1">
							<el-descriptions-item label="이름">{{ userInfo.userName }}
							</el-descriptions-item>
							<el-descriptions-item label="닉네임">{{ userInfo.nickName }}
							</el-descriptions-item>
							<el-descriptions-item label="성별">{{ userInfo.sex==0?"남":"여" }}</el-descriptions-item>
							<el-descriptions-item label="소개">{{ userInfo.signature }}</el-descriptions-item>
						</el-descriptions>
					</div>
				</div>
				<div class="btn-group">
	...
	export default {
		...
		methods: {
			...
			handleDelItem(friend, index) {
				this.$confirm(`'${friend.nickName}'삭제합니다?`, '알림', {
